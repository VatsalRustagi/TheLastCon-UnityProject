...
public class PlanningTheCon : MonoBehaviour {
    ...
    string[] dialogues = {
        "Future Self: Good job! We pulled it off, " +
        "now we have enough for the last con to get you out of this mess.",
        "Kyle: So, do you have something planned already?",
        "Future Self: Yes, I know a con that can clear your debt with the mafia but you're going to have to steal something in the end.",
        "Kyle: Steal? No I don't do that, I'm just a confidence man! I'm no theif.",
        "Future Self: Now is not the time to have a moral compass, we've been cheating people for years and I don't want to die because my past self " +
        "can't do what it takes!",
        "Kyle: Ok Calm Down. I'll do it. So who's the mark and what are we stealing?",
        "Future Self: The mark is a rich, single women by the name of Mariè Phillips who has a very rare Fabergé egg. I used the money from previous con to get us " +
        "some valuable information. I know everything we'll need to get into her house get the egg and disappear forever.",
        "Kyle: So what's the first step now?",
        "Future Self: My contacts told me that she's going to be at this new restaurant called Alinéa tomorrow night. " +
        ...
        "Kyle: Sounds like a plan. Lets get cleaned up and head over to Alinéa for dinner tomorrow",
